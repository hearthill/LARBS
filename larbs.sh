...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/hearthill/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/hearthill/LARBS/master/progs.csv"
